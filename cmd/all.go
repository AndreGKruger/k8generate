...
func init() {
	...
	allCmd.Flags().StringVarP(&Repoendpoint, "repoendpoint", "r", "", "endpoint of the repository IE: xyz.dkr.ecr.eu-west-1.amazonaws.com")
	allCmd.MarkFlagRequired("repoendpoint")
	allCmd.Flags().StringVarP(&Reponame, "reponame", "p", "", "name of the repository IE: myrepo/myapp")
	allCmd.MarkFlagRequired("reponame")
	allCmd.Flags().StringVarP(&Repoversion, "repoversion", "v", "", "version of the repository IE: 1.0.0")
	allCmd.MarkFlagRequired("repoversion")
}
